...
if ! killall -q -0 rdesktop; then
    ...
    setsid nohup rdesktop -a 32 -g 1366x730 -r disk:myshare=/tmp/rdesktop -u lixq -p "$(awk '/^xp/{print $5}' /mnt/lixq/vod/sbin/ha.txt)" "$(awk '/^xp/{print $3}' /mnt/lixq/vod/sbin/ha.txt)" &
fi
